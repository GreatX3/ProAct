...
def split_padded_tensor_dict_into_mb_list(
    ...
    # data:
    # 'input_ids', torch.Size([8, 32721])
    # 'loss_mask', torch.Size([8, 32721])
    # 'attention_mask', torch.Size([8, 32721])
    # 'prox_logp', torch.Size([8, 32721])
    # 'logprobs', torch.Size([8, 32721])
    # 'returns', torch.Size([8, 32721])
    # 'advantages', torch.Size([8, 32721])
